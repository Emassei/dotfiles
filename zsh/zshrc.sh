...
alias headphones='pactl set-card-profile alsa_card.pci-0000_00_1f.3 off; pactl set-card-profile alsa_card.usb-Lenovo_ThinkPad_USB-C_Dock_Gen2_USB_Audio_000000000000-00 output:iec958-stereo+input:multichannel-input'
